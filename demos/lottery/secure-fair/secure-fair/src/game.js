        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          ...
          <div class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav ml-auto">
              <li class="nav-item"><a href="#" class="nav-link"><img src="https://media.licdn.com/dms/image/C5603AQEmSjsFrpB8KQ/profile-displayphoto-shrink_800_800/0?e=1562198400&v=beta&t=k-fOBuGYL2r8c8TzR_sjtMCzDnqnEEPpNolceCXgP-8" class="profile-img" /> Sam Dovgin</a></li>
            </ul>
          </div>
        </nav>
